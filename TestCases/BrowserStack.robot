...
${RemoteURL}        http://prasad200:23qX1DDcWCF85WmsDanw@hub.browserstack.com:80/wd/hub
${StackBrowser}     Chrome
${BROWSER_VERSION}    62
...
BrowserStackDemo    
    ...
    Open Application    http://prasad200:23qX1DDcWCF85WmsDanw@hub.browserstack.com:80/wd/hub     platformName=MAC         deviceName=iPhone 6S         browserName=iPhone
