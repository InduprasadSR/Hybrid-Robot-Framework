...
Test_Sauce_Lab
    Open Browser   url=http://your_url/gateway-portal/html/    browser=${StackBrowser}   remote_url=${RemoteURL}   desired_capabilities=browser:${StackBrowser},browser_version:${BROWSER_VERSION},os:Windows,os_version:10  
